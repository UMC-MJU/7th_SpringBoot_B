...
public class QMemberMission extends EntityPathBase<MemberMission> {
    ...
    private static final long serialVersionUID = 938981214L;
    ...
    public final EnumPath<com.example.study.domain.enums.MissionStatus> status = createEnum("status", com.example.study.domain.enums.MissionStatus.class);
